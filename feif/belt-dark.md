  ...
  <div class="grid lg:grid-cols-2 gap-12 lg:gap-20">
    ...
    <div>
      <div class="aspect-square bg-neutral-50 mb-4">
        <img src="/images/feif/db_1.jpg" alt="Dark vegetable-tanned leather belt with nickel buckle" class="w-full h-full object-cover" id="main-image">
      </div>
      <div class="grid grid-cols-2 gap-4">
        <button class="aspect-square bg-neutral-50 ring-2 ring-neutral-900 ring-offset-2" onclick="document.getElementById('main-image').src='/images/feif/db_1.jpg'; updateThumbs(this)">
          <img src="/images/feif/db_1.jpg" alt="Full belt" class="w-full h-full object-cover">
        </button>
        <button class="aspect-square bg-neutral-50" onclick="document.getElementById('main-image').src='/images/feif/db_2.jpg'; updateThumbs(this)">
          <img src="/images/feif/db_2.jpg" alt="Buckle detail" class="w-full h-full object-cover">
        </button>
      </div>
    </div>
    ...
    <div class="lg:py-8">
      ...
      <p class="text-neutral-500 mt-1">Dark Leather</p>
